namespace SolrCore.QueryBuilder
{
    ...
    public class ParentWhich : Query
    {
        private readonly MinusNestPath _minusNestPath;
        private readonly PlusNestPath _plusNestPath;
        private readonly Query _query;

        public ParentWhich(Query query = null, MinusNestPath minusNestPath = null, PlusNestPath plusNestPath = null)
        {
            if (query == null)
            {
                query = new AllQuery();
